...
resource "aws_customer_gateway" "this" {
  ...
  bgp_asn    = 65000
  ip_address = aws_eip.vpc-b-public.public_ip
  type       = "ipsec.1"

  tags = {
    Name = "vpc-b-customer-gateway"
  }
}
...
resource "aws_vpn_connection" "this" {
  ...
  tunnel1_preshared_key = local.secret
  tunnel2_preshared_key = local.secret
  tags = {
    Name = "vpn-aws-a-to-vpc-b"
  }
}
...
module "ec2-vpn-b" {
  ...
  user_data_vars = {
    LEFT         = "%defaultroute"
    LEFT_ID      = aws_eip.vpc-b-public.public_ip
    LEFT_SUBNET  = module.vpc-b.vpc_cidr_block
    RIGHT        = aws_vpn_connection.this.tunnel1_address
    RIGHT_ID     = aws_vpn_connection.this.tunnel1_address
    RIGHT_SUBNET = module.vpc-a.vpc_cidr_block
    SECRET       = local.secret
    ENABLE_LOG   = "false"
  }
  ...
  security_group_rules = {
    ...
    ingress_udp_500 = {
      ...
      to_port     = 500
      protocol    = "udp"
      cidr_blocks = ["${aws_vpn_connection.this.tunnel1_address}/32", module.vpc-b.vpc_cidr_block]
      type        = "ingress"
    }
    ingress_udp_4500 = {
      from_port   = 4500
    ...
    ingress_icmp = {
      ...
      to_port     = -1
      protocol    = "icmp"
      cidr_blocks = ["${aws_vpn_connection.this.tunnel1_address}/32", module.vpc-a.vpc_cidr_block, module.vpc-b.vpc_cidr_block]
      type        = "ingress"
    }
...
# VPN Gateway
resource "aws_vpn_gateway_route_propagation" "vpn-a-private" {
  provider       = aws.provider_a
...
resource "aws_vpn_gateway_route_propagation" "vpn-a-public" {
  provider       = aws.provider_a
